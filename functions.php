...
function add_theme_scripts() {
    ...
    wp_enqueue_script( 'bquery', get_template_directory_uri() . '/js/jquery.min.js','','',true);
    wp_enqueue_script( 'wfonts', get_template_directory_uri() . '/MyFontsWebfontsKit.js','','',true);
    wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/modernizr.js','','',true);
    wp_enqueue_script( 'smoothStates', get_template_directory_uri() . '/js/smoothstates.js','','',true);
    wp_enqueue_script( 'customSmoothStates', get_template_directory_uri() . '/js/customsmoothstate.js','','',true);
    wp_enqueue_script( 'waypoints', get_template_directory_uri() . '/js/jquery.waypoints.min.js','','',true);
    wp_enqueue_script( 'sticky', get_template_directory_uri() . '/js/sticky.min.js','','',true);
...
register_post_type( 'show', array(
  ...
  'description' => 'Shows are where you add in the show.',
...
add_action( 'init', 'show_function' );

// Add custom post type Work


// Build Taxonomies Into Work Type

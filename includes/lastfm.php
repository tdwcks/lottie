...
$user = "tdwcks"; // <---- Your username goes here
$key = "48b32d94a11f92625dabf270bc7c765e"; //<-- Your API key goes here
...
if (isset($last['@attr']['nowplaying'])) {
	...
	$output = "we are currently listening to " . $last['name'] . ' by ' . $last['artist']['#text'] . " on Spotify.";
	...
	$output = "We last listened to " . $last['name'] . ' by ' . $last['artist']['#text'] . " $time on Spotify";
